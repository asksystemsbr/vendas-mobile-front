//src/app/client/clientCreate.tsx
"use client";
...
export const ClientCreateForm = ({ onSave, onClose,setSnackbar  }: ClientCreateFormProps) => {
  ...
  return (
    <div className="max-h-[80vh] overflow-y-auto p-4 bg-white rounded-lg shadow-md" >
      <form onSubmit={handleSubmit(onSubmit)} className="p-4 bg-white rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4 text-center">Novo Cliente</h2>
