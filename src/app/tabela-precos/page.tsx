...
export default function ListaPrecosGeral() {
  ...
  const handleSearchProduto = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const atualizarProduto = (id: number, campo: string, valor: string| number) => {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-xl font-bold mb-4">Tabela de Preços</h1>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Código Fábrica: {produto.codigoInterno ?? ""}
                </p>
                <div className="flex flex-col">
                  <label className="text-sm">Código Cliente:</label>
                  <input
                    type="text"
                    value={produto.totalizadorParcial ?? ""}
                     onChange={(e) =>
                       atualizarProduto(produto.id, "totalizadorParcial", e.target.value)
                     }
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    value={produto.valorVenda !== undefined ? produto.valorVenda.toString() : ""}
                    onChange={(e) => {
                      const valor = e.target.value.replace(/[^0-9,.]/g, "").replace(",", ".");
                      atualizarProduto(produto.id, "valorVenda", valor);
                    }}
                    className="border rounded w-full py-1 px-2"
                  />
                </div>
        ...
        {listaFinal.map((produto) => (
          <div key={produto.id} className="flex flex-col border p-2 rounded space-y-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Código Cliente: {produto.totalizadorParcial ?? ""}
              </p>                            
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="ml-2">R$ {(Number(produto.valorVenda) || 0).toFixed(2)}</span>
              </div>
            </div>
